...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birthdate: @actor.birthdate, fname: @actor.fname, name: @actor.name, workingcountry: @actor.workingcountry } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birthdate: @actor.birthdate, fname: @actor.fname, name: @actor.name, workingcountry: @actor.workingcountry } }
