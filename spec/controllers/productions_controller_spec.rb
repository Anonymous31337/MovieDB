...
RSpec.describe ProductionsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      production = Production.create! valid_attributes
      get :show, params: {id: production.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      production = Production.create! valid_attributes
      get :edit, params: {id: production.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Production" do
        expect {
          post :create, params: {production: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {production: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested production" do
        production = Production.create! valid_attributes
        put :update, params: {id: production.to_param, production: new_attributes}, session: valid_session
        production.reload
      ...
      it "redirects to the production" do
        production = Production.create! valid_attributes
        put :update, params: {id: production.to_param, production: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        production = Production.create! valid_attributes
        put :update, params: {id: production.to_param, production: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested production" do
      production = Production.create! valid_attributes
      expect {
        delete :destroy, params: {id: production.to_param}, session: valid_session
      }.to change(Production, :count).by(-1)
    end
